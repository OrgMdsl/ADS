...
$(document).ready(function () {
    ...
    //Tela CadastroGenerico

    var tabela_itens;
    if (!isEdicao) {
        tabela_itens = $('#listagem-GenericoItem').DataTable({
            columns: [
                {
                    width: '40%',
                    title: 'Descrição'
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: function (data) {
                        return Componente.Icones.Editar("PaginaEditarGenerico?id=" + data.id + "&op=E")
                                + Componente.Icones.Excluir("");
                    }
                }
            ]
...
function salvar()
{
    var table = $('#listagem-GenericoItem').DataTable();
