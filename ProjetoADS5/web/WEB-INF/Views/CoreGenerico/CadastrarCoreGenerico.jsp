...
<html>
    <head>
        ...
        <script src="additional/CadastrarCoreGenerico.js" type="text/javascript"></script>
    </head>
    <body>
            ...
            <div class="col-lg-12">
                <div class="panel-body">
                    <div class="form-group">
                        <form class="form-horizontal" action="CadastrarCoreGenerico" id="form-coreGenericoItem">
